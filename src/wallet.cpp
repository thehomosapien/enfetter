...
// Enfetter: total coins staked (non-spendable until maturity)
...
// Enfetter: get current stake weight
...
// Enfetter: check 'spent' consistency between wallet and txindex
// Enfetter: fix wallet spent state according to txindex
...
// Enfetter: disable transaction (only for coinstake)
